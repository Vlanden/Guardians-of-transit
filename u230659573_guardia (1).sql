...
--
-- Servidor: localhost
-- Tiempo de generación: 07-05-2025 a las 00:23:49
...
(100000, 'Juego simulacion 1', 'Se presenta una serie de caidas para analizar errores', 'juegos/quiz/game1.jpg');
...
--
ALTER TABLE `juegos_quiz`
  MODIFY `id_quiz` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `juegos_sim`
--
ALTER TABLE `juegos_sim`
  MODIFY `id_sim` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100001;
...
--
ALTER TABLE `quiz_preguntas`
  MODIFY `id_pregunta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `quiz_simulacion`
--
ALTER TABLE `quiz_simulacion`
  MODIFY `id_pregunta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
